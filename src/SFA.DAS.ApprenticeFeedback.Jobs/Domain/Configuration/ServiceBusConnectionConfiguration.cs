...
//            {
//                throw new InvalidOperationException($"ConnectionString must be set against {serviceBusConnectionConfigSetting} for Local or {fullyQualifiedNamespaceConfigSetting} for environments");
//            }
